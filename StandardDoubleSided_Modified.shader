...
Shader "Brush/StandardDoubleSided_ModifiedWithTime" {
    Properties {
        ...
        _AlbedoFadeColor("Albedo Fade Color", Color) = (0,0,0,1)
    ...
    SubShader {
        ...
        fixed4 _Color;
        half _Shininess;
        fixed _FadeAmount; // New property for controlling fade amount
        ...
        Input vert (inout appdata_full i, out Input o) {
            o = (Input)0;
            i.color = TbVertToNative(i.color);
            i.texcoord2.w = invLerp(i.texcoord2.x, i.texcoord2.y, i.texcoord2.z);
        ...
        void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
            ...
            float completion = CalcFeather(IN.clipinfo, tex.a,  preclamp);
            ...
            o.Albedo = completion*tex.rgb * _Color.rgb * IN.color.rgb;
            o.Albedo = lerp(o.Albedo, o.Albedo*_AlbedoFadeColor, fadeEdge);
            ...
            //o.Emission = completion;
            // Apply the fade effect to the alpha channel
            o.Alpha = tex.a * IN.color.a * _FadeAmount*completion;
        }
        ENDCG
    }
