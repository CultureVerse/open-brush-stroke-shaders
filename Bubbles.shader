...
Shader "Brush/Particle/Bubbles_ModifiedWithTime" {
Properties {
...
UNITY_VERTEX_OUTPUT_STEREO
      ...
      fixed4 frag (v2f i) : SV_Target
      {
        ...
        preclamp = saturate(4.0*preclamp);
        float preclamp2 = saturate(2.5*preclamp);

        float4 tex = tex2D(_MainTex, preclamp2*(i.texcoord-0.5)+0.5);
        ...
        return SrgbToNative(color)*preclamp;
      }
      ENDCG
    }
  }
